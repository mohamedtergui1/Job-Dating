                         ...
                         <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                            ...
                            <td class="px-6 py-4">
                                ...
                                <form action="{{ route('annonces.destroy',$annonce->id) }}" method="post">
                                    ...
                                    <button  id="{{$annonce->id}}" data-modal-target="deleteModal" data-modal-toggle="deleteModal"   class="font-medium text-red-600 dark:text-red-500 hover:underline">Dlete</>
